...
Public Class frmGenerarAFPNet
    ...
    Private Sub frmGenerarAFPNet_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub btnAFPNet_Click(sender As Object, e As EventArgs) Handles btnAFPNet.Click
        If _planillasRemuneracion IsNot Nothing Then
            Dim dtBase = fncDataTableAFP()

            For Each _planilla In _planillasRemuneracion
                If _planilla.AFP.Trim() <> "ONP" Then
                    fncIngresaEnAFP(dtBase, _planilla.CUSPP, _planilla.Dni, _planilla.ApellidoPaterno, _planilla.ApellidoMaterno, _planilla.Nombre, _planilla.TotIng, _planilla.AFP)
                End If
            Next
