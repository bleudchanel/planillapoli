...
{
    [DataContract]
    [Table("PlanillasRemHistorial", Schema = "Planilla")]
    public class PlanillaRemuneracionHistorial : EntityBase, IIdentifiableEntity
    {

        public PlanillaRemuneracionHistorial(int idPlanilla,
        ...
        public PlanillaRemuneracionHistorial()
        {

        }

        public PlanillaRemuneracionHistorial(PlanillaRemuneracion planillaBase)
        {
        ...
        [DataMember]
        public int IdPlanillaHistorial { get; set; }
        [DataMember]
